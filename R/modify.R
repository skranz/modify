...
#' Fast modification of data.frames and data.tables by reference
#' 
...
#' @param .where optional a boolean conditions that specifies the rows that shall be modifed
...
#' @export 
modify = function(.data,.where,.by=NULL,..., .envir=parent.frame()) {
